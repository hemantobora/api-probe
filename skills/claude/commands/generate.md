...
Scan the codebase or parse the provided collection file. Build a complete internal picture before asking anything. Do not output findings yet — just collect them.
